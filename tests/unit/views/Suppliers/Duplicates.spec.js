...
vi.mock("@/views/Suppliers/components/MergeConfirmationModal.vue", () => ({
  default: {
...
import Duplicates from "@/views/Suppliers/Duplicates.vue";
    ...
    realproducts: [
      {
        ...
        ean: "5900000012345",
        weight: "0.150",
        suppliers: [{ idx: "ft", name: "Fortrade", is_preferred: true }],
      },
      {
        sku: "KH-B",
        ean: "5900000012345",
        weight: "0.155",
        suppliers: [{ idx: "kh", name: "Kinghoff", is_preferred: false }],
      },
    ],
    suggestion: "merge",
