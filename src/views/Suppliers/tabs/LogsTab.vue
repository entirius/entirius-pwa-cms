  ...
  <div class="logs-tab p-300 ovy-auto h-100">
    ...
    <div v-if="activeMode === 'feed_runs'">
      ...
      <DataTable
        ...
        :rows="importLogs"
        row-key="id"
        :empty-text="$t('suppliers.logs.no_runs')"
      >
    ...
    <div v-else>
      <div class="flex ai-ct flex-wrap gap-200 mb-300">
        ...
        />
        <Switcher
          :label="$t('suppliers.logs.show_acknowledged')"
      ...
      <DataTable
        ...
        :rows="events"
        row-key="id"
        :empty-text="$t('suppliers.logs.no_events')"
  ...
  computed: {
    modeOptions() {
      return [
        {
          value: "feed_runs",
          label: this.$t("suppliers.logs.feed_runs"),
          testid: "logs-mode-feed-runs",
        },
        {
          value: "events",
          label: this.$t("suppliers.logs.events"),
    ...
    severityOptions() {
      return [
        ...
        { value: "critical", label: this.$t("suppliers.severity.critical") },
        { value: "warning", label: this.$t("suppliers.severity.warning") },
        { value: "info", label: this.$t("suppliers.severity.info") },
      ];
    },
    feedRunColumns() {
      return [
        {
          key: "run_id",
          label: this.$t("suppliers.logs.col.run_id"),
          width: "1.4fr",
        },
        {
          key: "mode",
          label: this.$t("suppliers.logs.col.mode"),
          width: "80px",
        },
        {
          key: "status",
        ...
        {
          key: "started_at",
          label: this.$t("suppliers.logs.col.started"),
          width: "1fr",
        },
        {
          key: "finished_at",
          label: this.$t("suppliers.logs.col.finished"),
          width: "1fr",
        },
        {
          key: "total_count",
          label: this.$t("suppliers.logs.col.total"),
          width: "70px",
        },
        {
          key: "error_count",
          label: this.$t("suppliers.logs.col.errors"),
          width: "70px",
        },
      ];
    },
    eventColumns() {
      return [
        {
          key: "created_at",
          label: this.$t("suppliers.logs.col.created"),
          width: "1fr",
        },
        {
          key: "severity",
          label: this.$t("suppliers.severity.label"),
          width: "100px",
        },
        {
          key: "event_type",
          label: this.$t("suppliers.logs.col.event_type"),
          width: "1.5fr",
        },
        {
          key: "message",
          label: this.$t("suppliers.logs.col.message"),
          width: "2fr",
        },
  ...
  methods: {
    ...
    async acknowledge(row) {
      try {
        ...
        this.notify.spawnNotification({
          type: "positive",
          msg: this.$t("suppliers.logs.ack_success"),
        });
        this.fetchLogs();
      } catch (err) {
        this.notify.spawnNotification({
