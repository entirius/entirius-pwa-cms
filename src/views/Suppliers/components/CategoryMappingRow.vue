<template>
  <div class="mapping-row b-basic-300 br-sm p-200 mb-100">
    <div class="mapping-row__grid">
      <FormField
        :label="$t('suppliers.mappings.category.source_field')"
        :tooltip="$t('suppliers.mappings.category.source_field_help')"
      >
        <EntitySearchPicker
          v-if="isNew"
          ...
          :placeholder="
            $t('suppliers.mappings.category.source_field_placeholder')
          "
          :client-filter="true"
      ...
      <FormField :label="$t('suppliers.mappings.category.source_value')">
        <SourceValuePicker
          v-if="isNew"
          ...
          :placeholder="
            $t('suppliers.mappings.category.source_value_placeholder')
          "
      ...
      <FormField :label="$t('suppliers.mappings.category.target_category_idx')">
        <EntitySearchPicker
          v-if="channelIdx"
          ...
          :placeholder="
            $t('suppliers.mappings.category.target_category_placeholder')
          "
        ...
        <BasicInput
          ...
          v-model="local.target_category_idx"
          :placeholder="
            $t('suppliers.mappings.category.target_category_no_channel_hint')
          "
          :data-testid="`cat-mapping-target-${rowKey}`"
        />
      </FormField>
